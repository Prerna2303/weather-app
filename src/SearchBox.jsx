...
function SearchBox({updateInfo}) {
    ...
    const API_KEY = "5245939c1b0051e7204381a14ed4413d";

    let kelvinToCelsius = (temp) => Math.round(temp - 273.15);
    ...
    let getWeatherInfo = async () => {
        ...
        let result = {
            ...
            tempMin:  kelvinToCelsius(jsonResponse.main.temp_min),
            tempMax: kelvinToCelsius(jsonResponse.main.temp_max),
